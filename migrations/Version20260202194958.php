 ...
 */
final class Version20260202194958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account_entry CHANGE created_by created_by VARCHAR(255) DEFAULT NULL, CHANGE account_id account_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE visit_item ADD status VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account_entry CHANGE created_by created_by INT DEFAULT NULL, CHANGE account_id account_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE visit_item DROP status');
    }
}
