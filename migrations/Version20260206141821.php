 ...
 */
final class Version20260206141821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient_account DROP INDEX IDX_2055034F6B899279, ADD UNIQUE INDEX UNIQ_2055034F6B899279 (patient_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient_account DROP INDEX UNIQ_2055034F6B899279, ADD INDEX IDX_2055034F6B899279 (patient_id)');
