 ...
 */
final class Version20260119134755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, company_id INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649979B1AD6 (company_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('DROP INDEX uq_company_patient ON patient_account');
        ...
        $this->addSql('ALTER TABLE patient_account RENAME INDEX fk_2055034f6b899279 TO IDX_2055034F6B899279');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX uq_company_patient ON patient_account (company_id, patient_id)');
        $this->addSql('ALTER TABLE patient_account RENAME INDEX idx_2055034f6b899279 TO FK_2055034F6B899279');
