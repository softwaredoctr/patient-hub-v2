 ...
 */
final class Version20260116175314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient_account DROP INDEX UNIQ_2055034F6B899279');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2055034F6B899279 ON patient_account (patient_id)');
